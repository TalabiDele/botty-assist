...
export class WhatsAppConfig {
        ...
        private static getChromePath(): string | undefined {
                ...
                switch (platform) {
                        ...
                        case 'linux':
                                // Try to find chromium using which command (works in Nix/Replit)
                                try {
                                        const whichChromium = execSync('which chromium', {
                                                encoding: 'utf8',
                                        }).trim()
                                        ...
                                        // which command failed, continue to standard paths
                                }
